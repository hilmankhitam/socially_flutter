  ...
  Widget frequentlyChatted() {
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: BlocBuilder<GetUserInfoChatBloc, GetUserInfoChatState>(
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  margin: EdgeInsets.only(
                    top: (index == 0) ? 16 : 0,
                    bottom: (index == users.length - 1) ? 70 : 21,
                  ),
                  child: ChatTile(
                    user: user,
                    onTap: () {
                  ...
                  if (snapshot.hasData) {
                    ...
                    return listUidUser.isEmpty
                        ...
                        : ListView(
                            ...
                            children: [
                              Container(
                                padding: EdgeInsets.fromLTRB(defaultMarginApps,
                                    16, defaultMarginApps, 10),
                                child: Text(
                                  'Frequently chatted',
